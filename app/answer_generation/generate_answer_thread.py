...
class GenerateAnswerThread(QtCore.QThread):
    ...
    def __init__(self, question_answerer, context, txt2speech, messages_model, question_text, question_id):
    ...
    def run(self):
        ...
        answer = self.question_answerer.get_answer(self.question_text, self.context)
